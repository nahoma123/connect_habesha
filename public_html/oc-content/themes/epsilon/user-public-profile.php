...
<body id="public">
  ...
  <div class="container primary">
    <div id="item-side">
      ...
      <a href="<?php echo osc_search_url(array('page' => 'search', 'userId' => osc_user_id())); ?>" class="seller-button seller-items"><?php echo __('Show all posts', 'epsilon') . ' (' . $user_item_count . ')'; ?></a>
