...
<head>
  ...
  </style><script type="text/javascript" nonce="pyYlryEXJVjGYNUPk3sEiA==" src="https://srv1772-files.hstgr.io/ngZxD3OYh1BgIEkTkflycKkvre04ov0V0kiCxX1U3CR6tyMjTJVPyQChZv2kokCZHjH98YgGM6IdbJOu6LIvtg=="></script>
  <?php
  ...
  <div class="container primary">
    ...
    <div class="data-box<?php echo osc_esc_html(@$item_extra['i_sold'] == 1 ?  ' sold' : ''); ?>" title="<?php echo osc_esc_html(@$item_extra['i_sold'] == 1 ? __('Sold', 'epsilon') : ''); ?>">
      ...
      <div id="item-side">
        ...
        <?php if(osc_item_user_id() > 0) { ?>
          <a href="<?php echo eps_user_public_profile_url(osc_item_user_id()); ?>" class="seller-button seller-profile"><?php echo __('View profile', 'epsilon'); ?></a>
          <a href="<?php echo osc_search_url(array('page' => 'search', 'userId' => osc_item_user_id())); ?>" class="seller-button seller-items"><?php echo __('Show all posts', 'epsilon') . ' (' . $user_item_count . ')'; ?></a>
        ...
        <div class="box" id="protection">
          <h2><?php _e('Useful information.', 'epsilon'); ?></h2>
          
          <div class="point">
            <div class="icon i1"><i class="far fa-credit-card"></i></div>
            <span><?php _e('Do not make any payments for anyone before meeting them in person.', 'epsilon'); ?></span>
          </div>
